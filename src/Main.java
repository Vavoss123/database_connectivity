...
public class Main {
    public static void main(String[] args) {
        ...
        // --- U: Update venue
        Venue updatedVenue = new Venue(1, "Grand Concert Hall", 250, "Concert", "Updated description");
        ...
        // --- U
        Performance updatedPerformance = new Performance(1, "Summer Gala", "Updated event desc", "Opera", start, end, 1);
